...
var _iterator = _createForOfIteratorHelper(accordionContents),
  _step;
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var accordionContent = _step.value;
...
try {
  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    var accordionButton = _step2.value;
...
accordion.addEventListener('click', function (e) {
  ...
  if (target.classList.contains('accordion__btn')) {
    var _accordionButtons = document.querySelectorAll('.accordion__btn');
    var _iterator3 = _createForOfIteratorHelper(_accordionButtons),
      _step3;
    try {
