...
/* harmony import */ var _modules_show_about__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-about */ "./js/modules/show-about.js");
/* harmony import */ var _modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/smooth-scroll */ "./js/modules/smooth-scroll.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mask_phone__WEBPACK_IMPORTED_MODULE_3__["initMask"])();
  Object(_modules_show_about__WEBPACK_IMPORTED_MODULE_4__["showAboutText"])();
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_5__["scrollToForm"])();
...
var accordionHandler = function accordionHandler(e) {
  var target = e.target;
      ...
      if (breakpoint.matches) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var accordionContent = _step2.value;
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var accordionButton = _step3.value;
            accordionButton.classList.add('accordion__btn--close');
          }
        } catch (err) {
          _iterator3.e(err);
        ...
        accordionContents = document.querySelectorAll('.accordion__content');
        accordionButtons = document.querySelectorAll('.accordion__btn');
        var _iterator4 = _createForOfIteratorHelper(accordionContents),
          _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var _accordionContent = _step4.value;
            _accordionContent.style.height = '';
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
        ...
        var _iterator5 = _createForOfIteratorHelper(accordionButtons),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var _accordionButton = _step5.value;
            _accordionButton.classList.remove('accordion__btn--close');
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
...
/*!***************************************!*\
  !*** ./js/modules/form-validation.js ***!
  \***************************************/
/*! exports provided: modalForm, resetErrors, initFormValidation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modalForm = document.forms[1];
var checkFormElement = function checkFormElement(elem) {
  ...
  if (elem.hasAttribute('pattern')) {
    var reg = new RegExp(elem.getAttribute('pattern'));
...
var showErrorElem = function showErrorElem(elem, message) {
...
var resetErrorElem = function resetErrorElem(elem) {
  var selector = "span[data-name-field=\"".concat(elem.name, "\"]");
  var errorElem = document.querySelector(selector);
  if (errorElem) {
    errorElem.remove();
  }
};
var resetErrors = function resetErrors(form) {
      ...
      var _loop = function _loop() {
        ...
        form.addEventListener('click', function (e) {
          ...
          if (target.classList.contains('form__button')) {
            ...
            var isValidForm = arrayValidElements.every(function (elem) {
              return elem === true;
            });
            if (isValidForm) {
              form.submit();
...
var initMask = function initMask() {
  telInputs.forEach(function (telInput) {
    return new imask__WEBPACK_IMPORTED_MODULE_0__["default"](telInput, {
...
/* harmony import */ var _modules_form_validation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../modules/form-validation */ "./js/modules/form-validation.js");
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function close() {
      ...
      Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_2__["resetErrors"])(_modules_form_validation__WEBPACK_IMPORTED_MODULE_2__["modalForm"]);
...
/*!**********************************!*\
  !*** ./js/modules/show-about.js ***!
  \**********************************/
/*! exports provided: showAboutText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showAboutText", function() { return showAboutText; });
var aboutBtn = document.querySelector('.about__btn');
var aboutText = document.querySelector('.about__text-more');
var aboutMobile = document.querySelector('.about__text-mobile');
var showAboutText = function showAboutText() {
  if (aboutBtn && aboutText) {
    aboutBtn.addEventListener('click', function () {
      if (aboutText.classList.contains('is-shown')) {
        ...
        var heightFull = aboutText.scrollHeight;
        var heightFullMobile = aboutMobile.scrollHeight;
        aboutText.style.height = "".concat(heightFull, "px");
        aboutMobile.style.height = "".concat(heightFullMobile, "px");
...
var scrollToForm = function scrollToForm() {
  var smoothLinks = document.querySelectorAll('.smooth-link');
  ...
  try {
    var _loop = function _loop() {
      ...
      smoothLink.addEventListener('click', function (e) {
        e.preventDefault();
        var href = smoothLink.getAttribute('href');
